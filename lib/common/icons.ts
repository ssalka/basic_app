export default [
  ...
  },
  {
    ...
    id: 'double-caret-vertical',
    group: 'interface',
    tags: ['sort', 'arrow', 'list']
  },
  {
    name: 'Double caret: horizontal',
    id: 'double-caret-horizontal',
    group: 'interface',
    tags: ['sort', 'arrow', 'list']
  },
  {
    name: 'Sort: alphabetical descending',
    id: 'sort-alphabetical-desc',
    group: 'action',
    tags: ['order', 'list', 'array', 'arrange']
  },
  {
    name: 'Sort: numerical descending',
    id: 'sort-numerical-desc',
    group: 'action',
    tags: ['order', 'list', 'array', 'arrange']
  },
  {
  ...
  },
  {
    ...
    id: 'remove-column-left',
    group: 'table',
    tags: ['table', 'detach', 'delete']
  },
  {
    name: 'Remove column: right',
    id: 'remove-column-right',
    group: 'table',
    tags: ['table', 'detach', 'delete']
  },
  {
  ...
  },
  {
    ...
    id: 'double-chevron-up',
    group: 'interface',
    tags: ['arrows', 'multiple', 'direction']
  },
  {
    name: 'Double chevron: down',
    id: 'double-chevron-down',
    group: 'interface',
    tags: ['arrows', 'multiple', 'direction']
  },
  {
  ...
  },
  {
    ...
    id: 'drag-handle-vertical',
    group: 'action',
    tags: ['move', 'pull']
  },
  {
    name: 'Drag handle: horizontal',
    id: 'drag-handle-horizontal',
    group: 'action',
    tags: ['move', 'pull']
  },
  {
  ...
  },
  {
    ...
    id: 'curved-range-chart',
    group: 'data',
    tags: ['graph', 'diagram']
  },
  {
    name: 'Vertical bar chart: descending',
    id: 'vertical-bar-chart-desc',
    group: 'data',
    tags: ['graph', 'bar', 'histogram']
  },
  {
    name: 'Horizontal bar chart: descending',
    id: 'horizontal-bar-chart-desc',
    group: 'data',
    tags: ['graph', 'bar', 'histogram']
  },
  {
  ...
  },
  {
    ...
    id: 'symbol-triangle-up',
    group: 'interface',
    tags: ['shape', 'figure']
  },
  {
    name: 'Symbol: triangle down',
    id: 'symbol-triangle-down',
    group: 'interface',
    tags: ['shape', 'figure']
  },
  {
