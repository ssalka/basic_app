...
@mutation(`SchemaFormMutations(
  ...
  collection: upsertCollection(_id: $_id, name: $name, fields: $fields, description: $description, icon: $icon) {
    _db _collection _id
  ...
  return {
    ...
    submitForm(event) {
      ...
      this.props.upsertCollection(collection)
        ...
        .then(coll => this.props.history.push(`/collections${coll.path}`));
    }
  };
}
